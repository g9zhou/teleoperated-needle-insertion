...
#define ENABLE_NEEDLE_INSERTION
...
//  Serial.println(updatedPos);
  ...
  double ts = -0.002017257801552*updatedPos + 20.594368283120627;
...
#ifdef ENABLE_NEEDLE_INSERTION
  if ( xh >= -0.03 && xh < 0.02 ) {
    force = 160*(xh+0.03)*dxh;
//    Serial.println("fat");
  } else if ( xh >= 0.02 && xh < 0.04) {
    force = 100/1.5*(xh-0.02)+0.8;
//    Serial.println("mem");
  } else if ( xh >= 0.04 ) {
    force = (30*(xh-0.04)+11.2)*dxh;
//    Serial.println("liver");
  } else {
    force = 0;
  }
#endif
